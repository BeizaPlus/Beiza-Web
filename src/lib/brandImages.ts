...
export const HERO_CONTENT_CLASS =
  "relative z-10 mx-auto flex w-full max-w-6xl min-w-0 flex-1 items-end pt-28 md:pt-32 pl-[calc(var(--beiza-site-padding-x,1.25rem)+var(--beiza-content-indent,0rem))] pr-[calc(var(--beiza-site-padding-x,1.25rem)+var(--beiza-content-indent,0rem))]";
