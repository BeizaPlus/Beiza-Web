...
function MetricStat({
  ...
  return (
    <div className="flex flex-col gap-2 text-left p-6 glass-card-artistic">
      <p
      ...
      {sub ? (
        <p className="text-white/80 text-left">{sub}</p>
      ) : null}
    </div>
  );
}
...
const Services = () => {
  ...
  const [activeImage, setActiveImage] = useState("/images/gallery/IMG_0024.jpg");

  const serviceFeatures: FeatureItem[] = [
    {
      id: 1,
      title: "Memorial Tributes",
      image: "/images/gallery/IMG_0024.jpg",
      description: "Create beautiful digital legacy pages with tribute videos, interactive biography sections, and photo galleries. Our memorial tributes help families preserve precious memories and share stories across generations with elegant, user-friendly interfaces.",
      icon: BookHeart,
    },
    {
      id: 2,
      title: "Photo Books",
      image: "/images/gallery/IMG_0057.jpg",
      description: "Premium photo books crafted with the highest quality materials and printing techniques. We offer custom layouts, personalized covers, and professional design services to transform your memories into beautiful, lasting keepsakes.",
      icon: Camera,
    },
    {
      id: 3,
      title: "Coffins",
      image: "/images/gallery/IMG_0059.jpg",
      description: "Dignified and beautiful coffins crafted with care and respect. We offer quality materials, respectful designs, and custom options to ensure your loved one's final resting place reflects their dignity and your family's wishes.",
      icon: Box,
    },
    {
      id: 4,
      title: "Event Packages",
      image: "/images/gallery/IMG_0101.jpg",
      description: "Complete event planning and coordination for memorial services. Our comprehensive packages include venue management, catering services, and professional support to ensure every detail is handled with care and dignity.",
      icon: Calendar,
    },
    {
      id: 5,
      title: "Legacy Archives",
      image: "/images/gallery/IMG_0114.jpg",
      description: "Digital archiving services to preserve family history and memories for future generations. We offer document scanning, family tree creation, and long-term digital storage solutions to keep your family's story alive.",
      icon: Archive,
    },
  ];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="text-center py-16">
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4">
            Our <em className="italic text-primary">Services</em>
          </h1>

          {/* Bounce Cards - Centered right under title */}
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-4">
            Experience our services through the memories we help preserve and the legacies we help create. Comprehensive memorial and legacy services designed to honor your loved ones with dignity and care.
          </p>
        </section>
        ...
        <section className="py-16">
          <h2 className="text-3xl md:text-4xl font-serif text-white text-center mb-12">
            What We <em className="italic text-primary">Offer</em>
          </h2>

          <div className="mb-12 flex w-full flex-col lg:flex-row items-start justify-between gap-8 lg:gap-12">
                ...
                {serviceFeatures.map((feature) => (
                  <AccordionItem key={feature.id} value={`item-${feature.id}`}>
                    <AccordionTrigger
                      ...
                      className="cursor-pointer py-5 px-6 !no-underline transition glass-card-artistic mb-4 rounded-lg text-center"
                    >
                      <h6
                        className={`text-xl font-semibold text-center w-full ${feature.id === activeTabId ? "text-white" : "text-white/80"}`}
                      >
                        {feature.title}
                      </h6>
                    </AccordionTrigger>
            ...
            <div className="relative m-auto hidden lg:block w-full lg:w-1/2 overflow-hidden rounded-xl glass-card-artistic">
              <img
                src={activeImage}
                alt="Service preview"
                className="aspect-[4/3] rounded-md object-cover w-full h-auto"
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-transparent">
          <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
            <div className="flex flex-col gap-4 text-center max-w-2xl mx-auto mb-20">
              <h2 className="text-4xl font-semibold md:text-5xl text-white font-serif">
                Real <em className="italic text-primary">Results</em>
              </h2>
              <p className="text-muted-foreground">
                From memorial tributes to event coordination—BEIZA helps families honor their loved ones with dignity and care.
              </p>
            </div>

            <div className="relative">
              <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
                <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 glass-card-artistic">
                  <CardContent className="relative m-auto size-fit pt-6">
                    ...
                    <h2 className="mt-6 text-center text-3xl font-semibold text-white">Family Satisfaction</h2>
                    <p className="mt-2 text-center text-white/80">Based on client feedback and testimonials</p>
                  </CardContent>
                </Card>

                <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 glass-card-artistic">
                  <CardContent className="pt-6">
                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-white/20 before:border-white/10">
                      <Heart className="m-auto h-fit w-24 text-primary" strokeWidth={1} />
                    </div>
                    <div className="relative z-10 mt-6 space-y-2 text-center">
                      <h2 className="text-lg font-medium text-white">Compassionate Care</h2>
                      <p className="text-white/80">Every service is delivered with empathy, dignity, and respect for your family's needs during difficult times.</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 glass-card-artistic">
                  <CardContent className="pt-6">
                    ...
                    <div className="relative z-10 mt-14 space-y-2 text-center">
                      <h2 className="text-lg font-medium text-white">Growing Trust</h2>
                      <p className="text-white/80">Our reputation for excellence continues to grow as more families trust us with their most precious memories.</p>
                    </div>
                  </CardContent>
                </Card>

                <Card className="relative col-span-full overflow-hidden lg:col-span-3 glass-card-artistic">
                  <CardContent className="grid pt-6 sm:grid-cols-2">
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-white/20 before:border-white/10">
                        <Shield className="m-auto size-5 text-primary" strokeWidth={1} />
                      </div>
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium text-white">Secure & Dignified</h2>
                        <p className="text-white/80">Your memories are protected with the highest standards of security and handled with utmost dignity.</p>
                      </div>
                    </div>
                    <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/20 p-6 py-6 sm:ml-6">
                ...
                <Card className="relative col-span-full overflow-hidden lg:col-span-3 glass-card-artistic">
                  <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      ...
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium text-white">Family-Centered Approach</h2>
                        <p className="text-white/80">We work closely with families to ensure every detail reflects their loved one's unique story and legacy.</p>
                      </div>
                    </div>
                    <div className="before:bg-white/20 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                      <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                          <span className="block h-fit rounded border border-white/20 bg-white/10 px-2 py-1 text-xs text-white">Sarah J.</span>
                          <div className="ring-background size-7 ring-4 ring-white/20">
                        ...
                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                          <div className="ring-background size-8 ring-4 ring-white/20">
                            <div className="size-full rounded-full bg-primary/20 flex items-center justify-center">
                              <BookHeart className="size-4 text-primary" />
                            </div>
                          </div>
                          <span className="block h-fit rounded border border-white/20 bg-white/10 px-2 py-1 text-xs text-white">Michael C.</span>
                        </div>
                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                          <span className="block h-fit rounded border border-white/20 bg-white/10 px-2 py-1 text-xs text-white">Robert W.</span>
                          <div className="ring-background size-7 ring-4 ring-white/20">
                            <div className="size-full rounded-full bg-primary/20 flex items-center justify-center">
