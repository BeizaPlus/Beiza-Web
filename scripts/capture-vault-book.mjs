...
const book = page.locator('img[alt*="families documenting their legacies"]');
await book.waitFor({ state: "visible", timeout: 30000 });
await book.scrollIntoViewIfNeeded();
await page.locator('figure:has(img[alt*="families documenting their legacies"])').screenshot({ path: OUT });
