...
const STATIC_ROUTES = [
  ...
  { path: "/booklet", label: "Booklet redirect", expectFinal: "/memoirs" },
  { path: "/packet", label: "Packet redirect", expectFinal: "/legacy/family" },
  { path: "/services", label: "Services redirect", expectFinal: "/contact" },
